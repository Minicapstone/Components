        ...
        <div className="fixed inset-0 z-10 flex justify-center items-center bg-black bg-opacity-50">
          <div className="modal bg-peach p-6 rounded-lg">
            ...
            <div className="flex justify-end">
              ...
              <button className="bg-blue-600 text-white py-2 px-4 rounded mr-2 bg-blue" onClick={handleResetPassword}>Confirm
              </button>

              <button className="bg-gray-300 text-gray-800 py-2 px-4 rounded bg-gray" onClick={handleCloseModal}>Cancel
              </button>
            </div>
          </div>
        </div>
