      ...
      {!isOpen ? (
        ...
        <div className="relative top-0 left-0 h-full w-20 bg-maroon z-50 transition-sidebar rounded-r-xl">
          <ul className="flex flex-col h-full gap-2">
            ...
            <Link to="/walkin">
              <li className={`text-3xl text-center px-4 py-3 m-2 text-white ${isActive("/walkin") ? "bg-blue rounded-xl" : ""} hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}>
                <MdPerson />
              </li>
            </Link>
        ...
        <div className="relative top-0 left-0 h-full bg-maroon w-72 rounded-r-xl transition-sidebar">
          <ul className="flex flex-col min-h-screen gap-2">
            ...
            <Link to="/walkin">
              <li className={`text-white text-base flex items-center px-4 py-3 m-2 ${isActive("/walkin") ? "bg-blue rounded-xl" : ""} hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}>
                <MdPerson className="text-3xl mr-2" />Walk In
              </li>
            </Link>
            <Link to="/search-books">
